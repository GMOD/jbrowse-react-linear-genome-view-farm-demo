...
function View() {
  ...
  return (
    <>
      <h1>JBrowse 2 React Linear Genome View Demo w/ farm</h1>
      <JBrowseLinearGenomeView viewState={viewState} />
      <h3>Code</h3>
      <p>
        The code for this app is available at{' '}
        <a
          href="https://github.com/GMOD/jbrowse-react-linear-genome-view-farm-demo"
          target="_blank"
          rel="noreferrer"
        >
          https://github.com/GMOD/jbrowse-react-linear-genome-view-farm-demo
        </a>
        .
      </p>
